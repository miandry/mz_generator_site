...
class __TwigTemplate_e3761c91eec43714fd602ee811c185ac extends \Twig\Template
{
    private $source;
    private $macros = [];
...
{% if secondary %}
  ...
  <ul>{{ secondary }}</ul>
{% endif %}
", "core/modules/system/templates/menu-local-tasks.html.twig", "/Applications/MAMP/htdocs/global_9/core/modules/system/templates/menu-local-tasks.html.twig");
    }
