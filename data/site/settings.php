 ...
 * @endcode
 */
$settings['hash_salt'] = 'u4-Oc6RfVbRYmL9ndwEB96thCYGn_y6nxEwWkHHKPrg1oLV_8qC2v2NQgiG-nfrfiwJElKsHhw';
...
$settings['maintenance_theme'] = 'staydirect_template_1';
...
$settings['file_private_path'] = 'sites/{{site_name}}/private';
$config_directories['sync'] = 'sites/{{site_name}}/files/config';
$settings['file_public_path'] = 'sites/{{site_name}}/files';
$settings['file_temp_path'] = 'sites/{{site_name}}/files/temp';
$config['system.file']['path']['temporary'] = 'sites/{{site_name}}/files/temp';

$settings['config_sync_directory'] = 'sites/{{site_name}}/files/config_0t9d1czwkHWzWIZ2PW5Ulvf1tahl66l6uWsybh5yAw-Yc8yvuBJukmFInTeVR_4d1_OxnTM8gQ/sync';
